...
// U1 courtyard center (0, 0)     → x: -1.13 to +1.13, y: -0.97 to +0.97
// U2 courtyard center (2.0, 1.7) → x: +0.87 to +3.13, y: +0.73 to +2.67
// X overlap: 0.87 → 1.13 (0.26 mm)
// Y overlap: 0.73 → 0.97 (0.24 mm) — both axes overlap → error
// U1 pad2 right: 0.78, U2 pad1 left: 1.22 — X pad gap: 0.44 mm → no pad overlap

test("courtyard overlap: diagonal (both X and Y axes)", () => {
