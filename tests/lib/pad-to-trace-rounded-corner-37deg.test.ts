...
test("snapshots pad-to-trace rounded-corner clearance at 37 degrees", () => {
  ...
  expect(svg).toMatchSvgSnapshot(
    import.meta.path,
    "pad-to-trace-rounded-corner-37deg",
  )
})

test.failing("accepts the legal pad-to-trace gap at 37 degrees", () => {
...
test("rejects the sharp-corner pad-to-trace gap at 37 degrees", () => {
