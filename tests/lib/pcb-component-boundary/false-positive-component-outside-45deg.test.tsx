...
test("no false positive: pinrow connectors rotated 45deg inside board should not trigger errors", async () => {
  ...
  const circuitJson = circuit
    .getCircuitJson()
    .filter((el) => !el.type.includes("error")) as AnyCircuitElement[]
