...
// Two different-net vias, outer_diameter 0.6mm, hole 0.3mm, centers 0.5mm apart:
...
test("flags different-net vias whose copper rings overlap even when the drill holes clear", async () => {
