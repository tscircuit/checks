...
test("snapshots via-to-pad rounded-corner clearance at 37 degrees", () => {
  ...
  expect(svg).toMatchSvgSnapshot(
    import.meta.path,
    "via-to-pad-rounded-corner-37deg",
  )
})
...
test("rejects the sharp-corner via-to-pad gap at 37 degrees", () => {
