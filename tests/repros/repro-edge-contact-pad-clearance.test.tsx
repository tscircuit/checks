...
// edge contact. This regression ensures that valid geometry on an
// off-board-allowed component is not reported as a clearance violation.
test("intentional edge-contact SMT pads should not report board-edge clearance errors", async () => {
